...
import com.myandy.common.constant.LOGIN_ACTIVITY_LOGIN
...
import com.myandy.login.databinding.ActivityLoginBinding
import com.myandy.login.policy.PrivacyPolicyActivity
import com.myandy.login.register.RegisterActivity
                ...
                object : ClickableSpan() {
                    override fun onClick(widget: View) {
                        (widget as TextView).highlightColor =
                            getColorFromResource(com.myandy.common.R.color.transparent)
