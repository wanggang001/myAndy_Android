package com.myandy.login.register
...
import com.myandy.common.constant.LOGIN_ACTIVITY_REGISTER
...
import com.myandy.framework.ext.textChangeFlow
...
import com.myandy.login.R
import com.myandy.login.databinding.ActivityRegisterBinding
import com.myandy.login.login.LoginViewModel
import com.myandy.login.policy.PrivacyPolicyActivity
...
class RegisterActivity : BaseMvvmActivity<ActivityRegisterBinding, LoginViewModel>() {
    ...
    private fun toRegister() {
        ...
        showLoading(com.myandy.common.R.string.default_loading)
            ...
            spaBuilder.setSpan(
                object : ClickableSpan() {
                    override fun onClick(widget: View) {
                        (widget as TextView).highlightColor = getColorFromResource(com.myandy.common.R.color.transparent)
                    ...
                    override fun updateDrawState(ds: TextPaint) {
                        ...
                        ds.color = getColorFromResource(com.myandy.common.R.color.color_0165b8)
