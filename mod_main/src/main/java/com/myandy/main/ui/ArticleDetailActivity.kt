...
import com.myandy.common.constant.KEY_TITLE
import com.myandy.common.constant.KEY_URL
import com.myandy.framework.base.BaseDataBindActivity
import com.myandy.main.databinding.ActivityArticleDetailBinding
...
class ArticleDetailActivity : BaseDataBindActivity<ActivityArticleDetailBinding>() {
     ...
     */
    private val mWebChromeClient = object : com.tencent.smtt.sdk.WebChromeClient() {
        /**
         * 网页Title更改
         */
